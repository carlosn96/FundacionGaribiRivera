...
} from "@/modules/auth/domain/models/AuthSchemas";
import { 
  VisionGlassWindow, 
  VisionTypography, 
  VisionText 
...
export function ForgotPasswordForm() {
  ...
  const handleVerifyCode = () => 
    executeAction(() => authService.verifyResetCode(targetEmail, verificationCode), (res) => {
      setCurrentStep(3);
      setFeedback({ type: "success", message: res.message });
    });
  ...
  if (isSuccess) {
    return (
      <VisionGlassWindow className="p-8 sm:p-10 shadow-2xl text-center" withNoise>
        <div className="flex justify-center mb-6"><Image src="/images/logo.svg" width={180} height={60} alt="Logo" priority style={{ width: 'auto', height: 'auto' }} /></div>
  ...
  return (
    <VisionGlassWindow className="p-8 sm:p-10 shadow-2xl" withNoise>
      ...
      <div className="text-center space-y-4 mb-8">
        <div className="flex justify-center mb-6 animate-in fade-in zoom-in duration-500"><Image src="/images/logo.svg" width={180} height={60} alt="Logo" priority style={{ width: 'auto', height: 'auto' }} /></div>
        <div className="space-y-2">
