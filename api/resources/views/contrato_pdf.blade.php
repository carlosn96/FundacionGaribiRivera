...
<head>
    ...
    <style>
        ...
        /* Eliminamos page-number CSS porque counter(pages) reporta 0 aquí. Usaremos script PHP */
        ...
        <div class="contract-doc">
            <div class="doc-body">
                ...
                <p class="mb-3 text-justify">
                    ...
                    <strong>FUNDACIÓN CARDENAL GARIBI RIVERA, FUNDACIÓN</strong>, REPRESENTADA POR EL C. PBRO. LIC.
                    EDUARDO DELFINO MENDOZA MEDINA, EN SU CARÁCTER DE PRESIDENTE EJECUTIVO, A QUIEN EN LO SUCESIVO SE LE
                ...
                <div class="mt-3">
                    ...
                    <p>1.1 Que es una fundación de carácter privado, sin fines de lucro, que está legalmente
                        constituida, con domicilio ubicado en la finca marcada con el número 4235 de la calle COBRE de
                        la colonia, LOMAS DE LA VICTORIA de la ciudad de Tlaquepaque, Jalisco.</p>
                    ...
                    <p>1.3. Que su presidente ejecutivo C. PBRO. LIC. EDUARDO DELFINO MENDOZA MEDINA tiene facultades
                        suficientes para celebrar el Presente Documento en representación de LA FUNDACION CARDENAL
                        GARIBI RIVERA, FUNDACION y que es su voluntad celebrar el presente "CONTRATO DE IMPULSO AL
                ...
                <table class="signature-grid">
                    <tr>
                        <td class="sig-html-cell">
                            <div class="sig-title">"LA FUNDACIÓN"</div>
                            <div class="sig-space"></div>
                            <div class="sig-name">LIC. PBRO. EDUARDO D. MENDOZA.</div>
                        </td>
                        <td class="sig-html-cell">
                            <div class="sig-title">"EL EMPRENDEDOR"</div>
                            <div class="sig-space"></div>
                            <div class="sig-name fw-bold">{{ $nombreE }}</div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="sig-html-cell">
                            <div class="sig-title">EL AVAL</div>
                            <div class="sig-space"></div>
                            <div class="sig-name fw-bold">{{ $nombreA }}</div>
                        </td>
                    </tr>
                    <tr>
                        <td class="sig-html-cell">
                            <div class="sig-title">TESTIGO</div>
                            <div class="sig-space"></div>
                            <div class="sig-name">C. CARMEN ÁLVAREZ FLORES</div>
                        </td>
                        <td class="sig-html-cell">
                            <div class="sig-title">TESTIGO</div>
                            <div class="sig-space"></div>
                            <div class="sig-name">C. MA. EMMA VALADEZ CRUZ</div>
                        </td>
                    </tr>
                </table>
            </div>
