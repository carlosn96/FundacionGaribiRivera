...
$options->set('isRemoteEnabled', true); // Habilitar carga de imágenes remotas si las hubiera
$options->set('defaultFont', 'helvetica'); // Establecer fuente por defecto
...
// Salida del PDF
$dompdf->stream($nombreArchivo . '.pdf', array("Attachment" => false)); // "Attachment" => false para mostrar en navegador, true para descargar
