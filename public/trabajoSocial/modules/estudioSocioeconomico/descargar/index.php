...
$map = [
    ...
    '{{refFamiliarNombre}}' => $estudio['referencias']['familiar']['nombre'],
    '{{refFamiliarTelefono}}' => $estudio['referencias']['familiar']['telefono'],
    '{{refFamiliarParentesco}}' => $estudio['referencias']['familiar']['parentesco'],
    '{{refFamiliarOpinion}}' => $estudio['referencias']['familiar']['opinion'],
