    ...
    <div class="bg-white border-bottom border-2 mb-4 py-4">
        <div class="container-fluid px-4">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-1 fw-bold text-success">Configuración de perfil</h4>
                    <p class="text-muted mb-0 small">Administra tu información personal y credenciales de acceso</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="bg-white rounded-3 border shadow-sm p-4">
                            ...
                            <!-- Security Alert -->
                            <div class="alert alert-success border d-flex align-items-start mt-4 mb-0">
                                <i class="ti ti-shield-check me-3 fs-5"></i>
                                <div class="small">
                                    <strong>Recomendación de seguridad:</strong> Cambia tu contraseña periódicamente y utiliza una combinación de letras, números y caracteres especiales.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-3">
            ...
            <form id="configuracionForm" class="needs-validation" novalidate>
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-warning border d-flex align-items-start mb-0">
                        <i class="ti ti-alert-triangle me-2 fs-5"></i>
                        <small>Recuerda guardar tu nueva contraseña en un lugar seguro</small>
                    </div>
                </div>
