            ...
            <div class="auth-card">
                <div class="auth-header auth-header--center">
                    ...
                    <p class="auth-subtitle">
                        <span class="auth-highlight"><?php echo htmlspecialchars($nombre); ?></span>, enviamos un código
                        a<br>
                        <span class="auth-highlight"><?php echo htmlspecialchars($correo); ?></span>
                    </p>
                </div>

                <div class="auth-resend" id="reenviarCodigo">
                    <a onclick="reenviarCodigo()" href="javascript:void(0)">
                        <i class="fas fa-redo me-1" style="font-size:0.65rem;"></i>Reenviar código
                    </a>
                </div>
                ...
                <form id="formValidarCuenta" method="post">
                    ...
                    <button type="submit" class="auth-btn auth-btn--primary">Validar cuenta</button>
