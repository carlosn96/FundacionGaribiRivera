                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-outline-info btn-round" data-toggle="modal" data-target="#modalAgregarCampo">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                <label>¿Cómo se conoció la Fundación?</label>
                                ...
                                <div class="modal-body">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <button type="button" data-toggle="tooltip" data-placement="top" title="" class="btn btn-danger btn-icon" data-original-title="" value="OcupacionActual1" onclick="eliminarRegistro({&quot;name&quot;:&quot;OcupacionActual&quot;,&quot;id&quot;:&quot;1&quot;,&quot;val&quot;:&quot;EMPLEADO FIJO&quot;})" id="btnEliminarOcupacionActual1">
                                                <span class="btn-label"><i class="fas fa-trash-alt"></i></span>
                                            </button>
                                        </div>
                                        <input id="OcupacionActual1" class="form-control" value="EMPLEADO FIJO" onchange="actualizar({&quot;name&quot;:&quot;OcupacionActual&quot;,&quot;id&quot;:&quot;1&quot;,&quot;val&quot;:&quot;EMPLEADO FIJO&quot;})">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-warning" data-dismiss="modal">Cancelar</button>
