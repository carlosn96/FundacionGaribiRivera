                ...
                <div class="card-header bg-white">
                    <form id="filterForm">
                        ...
                        <div class="input-group" id="selector">
                            ...
                            <button type="submit" class="btn btn-outline-danger" onclick="refresh()">Deshacer filtro</button>
                        </div>
                    </form>
                </div>
                <div class="card-body">
            ...
            <div class="tab-pane fade p-3" id="nuevaEtapa" role="tabpanel" aria-labelledby="nuevaEtapa-tab">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-subtitle mb-4 text-muted">Formulario para crear una nueva etapa</p>
