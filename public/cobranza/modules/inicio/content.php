...
<div class="modal fade" id="modalActualizarReferencia" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form id="form-actualizar-referencia">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title fw-semibold">
                        <i class="fas fa-edit text-primary me-2"></i>Actualizar Referencia de Crédito
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body pt-2">
                    <p class="text-muted">
                        Actualiza el número de referencia y la fecha de otorgamiento del crédito para <strong id="nombreEmprendedorRef"></strong>.
                    </p>
                    <div class="mb-3">
                        <label for="numeroReferencia" class="form-label fw-medium">
                            <i class="fas fa-credit-card text-primary me-2"></i>Número de Referencia
                        </label>
                        <input type="text" class="form-control" id="numeroReferencia" placeholder="Ej. 123456" required>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-0 pt-0">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnGuardarReferencia">
