<aside class="left-sidebar">
                ...
                <div class="scroll-sidebar" data-simplebar>
                    <div class="d-flex mb-4 align-items-center justify-content-between">
                        <a href="../index" class="text-nowrap logo-img ms-0 ms-md-1">
                        ...
                        <ul id="sidebarnav" class="mb-4 pb-2">
                            ...
                            <li class="sidebar-item">
                                <a
                                    ...
                                    <span class="hide-menu ms-2 ps-1">Planteles</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a
                                    ...
                                    <span class="hide-menu ms-2 ps-1">Carreras</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a
                                    ...
                                    <span class="hide-menu ms-2 ps-1">Coordinadores</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a
                                    ...
                                    <span class="hide-menu ms-2 ps-1">Elementos de Supervisión</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
