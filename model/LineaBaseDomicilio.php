...
class LineaBaseDomicilio {
    ...
    public function __construct(string $calle, string $calleCruce1, string $calleCruce2, string $numeroExterior, ?string $numeroInterior, int $codigoPostal, int $comunidadParroquial) {
        $this->calle = $calle;
